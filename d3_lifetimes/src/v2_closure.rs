...
impl Hider {
    ...
    //FnOnce = a function trait. F:FnOnce(&mut String) takes one mutable referenced String
    //FnMut = a function trait. function that contains changeable data
    //Fn = general function trait
