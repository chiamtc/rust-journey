...
impl Handler for PostFeedHandler {
    fn handle(&self, _: &mut Request) -> IronResult<Response> {
        //json encode the payload and unlock the self.database mutex
...
impl PostHandler {
    ...
    fn find_post(&self, id: &Uuid) -> Option<Post> {
        let locked = lock!(self.database); //unlock the mutex
...
//iron has middlewares -
// beforemiddleware - before request
// aroundmiddleware - able to manipulate before and after a request
// aftermiddleware - after request